...
namespace UnitTests.Appointments_Tests {
	...
	public class AppointmentsTests:TestBase {
		...
		public void UserContrApptsPanelJ_RoundTimeToNearestIncrement(){
			...
			TimeSpan timeSpanResult=OpenDental.UI.ContrApptPanel.RoundTimeToNearestIncrement(timeSpanInput,minPerIncr);
			Assert.IsTrue(timeSpanResult==new TimeSpan(11,50,0));
			timeSpanInput=new TimeSpan(11,52,0);
			timeSpanResult=OpenDental.UI.ContrApptPanel.RoundTimeToNearestIncrement(timeSpanInput,minPerIncr);
			Assert.IsTrue(timeSpanResult==new TimeSpan(11,50,0));
		...
		public void UserContrApptsPanelJ_RoundTimeDown(){
			float minPerIncr=10;
			TimeSpan timeSpanInput=new TimeSpan(11,50,0);
			TimeSpan timeSpanResult=OpenDental.UI.ContrApptPanel.RoundTimeDown(timeSpanInput,minPerIncr);
			Assert.IsTrue(timeSpanResult==new TimeSpan(11,50,0));
			timeSpanInput=new TimeSpan(11,52,0);
			timeSpanResult=OpenDental.UI.ContrApptPanel.RoundTimeDown(timeSpanInput,minPerIncr);
			Assert.IsTrue(timeSpanResult==new TimeSpan(11,50,0));
			timeSpanInput=new TimeSpan(11,48,0);
			timeSpanResult=OpenDental.UI.ContrApptPanel.RoundTimeDown(timeSpanInput,minPerIncr);
