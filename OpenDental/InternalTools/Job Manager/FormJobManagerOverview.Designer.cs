namespace OpenDental{
	partial class FormJobManagerOverview {
		...
		private void InitializeComponent() {
			...
			this.comboProposedVersion = new UI.ComboBoxPlus();
			...
			this.comboEngineers = new UI.ComboBoxPlus();
		...
		private UI.ComboBoxPlus comboEngineers;
		...
		private UI.ComboBoxPlus comboProposedVersion;
