...
namespace OpenDental {
	public partial class FormJobAdd:ODForm {
		...
		private void FillGridCustomers() {
			...
			gridCustomers.ListGridColumns.Add(new GridColumn("PatNum",-1));
		...
		private void FillGridSubscribers() {
			...
			gridSubscribers.ListGridColumns.Add(new GridColumn("User Name",-1));
		...
		private void FillGridQuotes() {
			...
			gridQuotes.ListGridColumns.Add(new GridColumn("PatNum",-1));
			gridQuotes.ListGridColumns.Add(new GridColumn("Hours",-1,HorizontalAlignment.Center));
			gridQuotes.ListGridColumns.Add(new GridColumn("Amt",-1,HorizontalAlignment.Right));
		...
		private void FillGridTasks() {
			...
			gridTasks.ListGridColumns.Add(new GridColumn("Date",-1));
			gridTasks.ListGridColumns.Add(new GridColumn("TaskList",-1));
		...
		private void FillGridFeatureReq() {
			...
			gridFeatureReq.ListGridColumns.Add(new GridColumn("Feat Req Num",-1));
		...
		private void FillGridBugs() {
			...
			gridBugs.ListGridColumns.Add(new GridColumn("Bug Num (From JRMT)",-1));
		...
		private void gridBugs_CellDoubleClick(object sender,ODGridClickEventArgs e) {
			...
			if(FormBE.BugCur==null) {
				_listJobLinks.RemoveAll(x => x.LinkType==JobLinkType.Bug && x.FKey==(long)gridBugs.ListGridRows[e.Row].Tag);
			}
			FillGridBugs();
		}
