...
namespace OpenDental {
	public partial class FormPhoneComps:ODForm {
		...
		private void FillMain() {
			...
			gridMain.ListGridColumns.Add(new GridColumn(Lan.g(gridMain.TranslationName,"Ext"),-1,GridSortingStrategy.AmountParse){IsEditable=true });
			gridMain.ListGridColumns.Add(new GridColumn(Lan.g(gridMain.TranslationName,"CompName"),-2,GridSortingStrategy.StringCompare));
