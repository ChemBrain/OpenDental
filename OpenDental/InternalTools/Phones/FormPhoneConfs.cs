...
namespace OpenDental {
	public partial class FormPhoneConfs:ODForm {
		...
		private void FillGrid() {
			...
			gridConfRoom.ListGridColumns.Add(new GridColumn("Occupants",0,HorizontalAlignment.Center,GridSortingStrategy.AmountParse));
		...
		private void gridConfRoom_CellDoubleClick(object sender,ODGridClickEventArgs e) {
			FormPhoneConfEdit FormPCE=new FormPhoneConfEdit((PhoneConf)gridConfRoom.ListGridRows[e.Row].Tag);
			FormPCE.ShowDialog();
