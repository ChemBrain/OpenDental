...
namespace OpenDental {
	public partial class FormRpOutstandingIns:ODForm {
		...
		private UI.ComboBoxPlus comboDateFilterBy;
		#endregion
		...
		private UI.ComboBoxPlus comboPreauthOptions;
		...
		private void InitializeComponent() {
			...
			this.comboPreauthOptions = new OpenDental.UI.ComboBoxPlus();
			...
			this.comboDateFilterBy = new OpenDental.UI.ComboBoxPlus();
			this.label3 = new System.Windows.Forms.Label();
			this.comboErrorDef = new OpenDental.UI.ComboBoxPlus();
			...
			this.comboLastClaimTrack = new OpenDental.UI.ComboBoxPlus();
				...
				() => { 
					List<RpOutstandingIns.OutstandingInsClaim> listOustandingInsClaims=
						RpOutstandingIns.GetOutInsClaims(_listSelectedProvNums,dateTimeFrom,dateTimeTo,
							_preauthOption,listClinicNums,carrier,_listSelectedUserNums,comboFilterBy
					);
