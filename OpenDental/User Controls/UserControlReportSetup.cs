...
namespace OpenDental.User_Controls {
    ...
    private void FillGrids() {
			...
			if(_isPermissionMode) {
				gridProdInc.ListGridColumns.Add(new GridColumn(allowedColumnTitle,0,HorizontalAlignment.Center));
			}
			else {
				gridProdInc.ListGridColumns.Add(new GridColumn(subMenuColumnTitle,0,HorizontalAlignment.Center));
				gridProdInc.ListGridColumns.Add(new GridColumn(hiddenColumnTitle,0,HorizontalAlignment.Center));
			}
			...
			if(_isPermissionMode) {
				gridDaily.ListGridColumns.Add(new GridColumn(allowedColumnTitle,0,HorizontalAlignment.Center));
			}
			else {
				gridDaily.ListGridColumns.Add(new GridColumn(subMenuColumnTitle,0,HorizontalAlignment.Center));
				gridDaily.ListGridColumns.Add(new GridColumn(hiddenColumnTitle,0,HorizontalAlignment.Center));
			}
			...
			if(_isPermissionMode) {
				gridMonthly.ListGridColumns.Add(new GridColumn(allowedColumnTitle,0,HorizontalAlignment.Center));
			}
			else {
				gridMonthly.ListGridColumns.Add(new GridColumn(subMenuColumnTitle,0,HorizontalAlignment.Center));
				gridMonthly.ListGridColumns.Add(new GridColumn(hiddenColumnTitle,0,HorizontalAlignment.Center));
			}
			...
			if(_isPermissionMode) {
				gridLists.ListGridColumns.Add(new GridColumn(allowedColumnTitle,0,HorizontalAlignment.Center));
			}
			else {
				gridLists.ListGridColumns.Add(new GridColumn(subMenuColumnTitle,0,HorizontalAlignment.Center));
				gridLists.ListGridColumns.Add(new GridColumn(hiddenColumnTitle,0,HorizontalAlignment.Center));
			}
			...
			if(_isPermissionMode) {
				gridPublicHealth.ListGridColumns.Add(new GridColumn(allowedColumnTitle,0,HorizontalAlignment.Center));
			}
			else {
				gridPublicHealth.ListGridColumns.Add(new GridColumn(subMenuColumnTitle,0,HorizontalAlignment.Center));
				gridPublicHealth.ListGridColumns.Add(new GridColumn(hiddenColumnTitle,0,HorizontalAlignment.Center));
			}
			//Add Rows
