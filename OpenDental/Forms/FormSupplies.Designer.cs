namespace OpenDental{
	partial class FormSupplies {
		...
		private void InitializeComponent() {
			...
			this.comboSuppliers = new OpenDental.UI.ComboBoxPlus();
			this.checkShowHidden = new System.Windows.Forms.CheckBox();
			this.butAdd = new OpenDental.UI.Button();
			this.gridMain = new OpenDental.UI.ODGrid();
			this.butSearch = new OpenDental.UI.Button();
			this.label2 = new System.Windows.Forms.Label();
			this.comboCategories = new OpenDental.UI.ComboBoxPlus();
    ...
    "hether that order then gets entered back into the software";
		...
		private UI.ComboBoxPlus comboSuppliers;
		...
		private UI.ComboBoxPlus comboCategories;
