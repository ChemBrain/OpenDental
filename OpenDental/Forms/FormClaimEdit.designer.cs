namespace OpenDental {
	partial class FormClaimEdit {
		...
		private void InitializeComponent() {
			...
			this.comboDateIllnessQualifier = new OpenDental.UI.ComboBoxPlus();
			...
			this.comboDateOtherQualifier = new OpenDental.UI.ComboBoxPlus();
			...
			this.comboProvTreat = new OpenDental.UI.ComboBoxPlus();
			this.comboProvBill = new OpenDental.UI.ComboBoxPlus();
    ...
    "ed in the Chart module. ";
			...
			this.textNote.Size = new System.Drawing.Size(446, 136);
		...
		private UI.ComboBoxPlus comboProvBill;
		private UI.ComboBoxPlus comboProvTreat;
		...
		private UI.ComboBoxPlus comboDateOtherQualifier;
		private System.Windows.Forms.Label labelDateIllnessQualifier;
		private UI.ComboBoxPlus comboDateIllnessQualifier;
