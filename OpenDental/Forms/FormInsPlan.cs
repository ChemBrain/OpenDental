...
///<summary></summary>
	public class FormInsPlan : ODForm {
		...
		private UI.ComboBoxPlus comboAllowedFeeSched;
		private Label labelCopayFeeSched;
		private Label label3;
		private UI.ComboBoxPlus comboCopay;
		...
		private void InitializeComponent(){
			...
			this.comboSendElectronically = new UI.ComboBoxPlus();
			...
			this.comboBillType = new UI.ComboBoxPlus();
