...
namespace OpenDental{
	partial class FormPatientEdit {
		...
		private void InitializeComponent(){
			...
			this.comboZip = new OpenDental.UI.ComboBoxPlus();
			...
			this.comboBillType = new OpenDental.UI.ComboBoxPlus();
			...
			this.comboFeeSched = new OpenDental.UI.ComboBoxPlus();
			this.labelCreditType = new System.Windows.Forms.Label();
			this.labelPriProv = new System.Windows.Forms.Label();
			this.comboPriProv = new OpenDental.UI.ComboBoxPlus();
			this.comboSecProv = new OpenDental.UI.ComboBoxPlus();
			...
			this.comboSpecialty = new OpenDental.UI.ComboBoxPlus();
			...
			// labelBirthdate
			// 
			this.labelBirthdate.Location = new System.Drawing.Point(5, 267);
			...
			// label20
			// 
			this.label20.Location = new System.Drawing.Point(318, 266);
			...
			// textAge
			// 
			this.textAge.Location = new System.Drawing.Point(365, 264);
			...
			// textBirthdate
			// 
			this.textBirthdate.Location = new System.Drawing.Point(160, 264);
			...
			// label32
			// 
			this.label32.Location = new System.Drawing.Point(324, 308);
			...
			// butAuto
			// 
			this.butAuto.Location = new System.Drawing.Point(257, 304);
			...
			// labelPutInInsPlan
			// 
			this.labelPutInInsPlan.Location = new System.Drawing.Point(321, 287);
			...
			// textMedicaidState
			// 
			this.textMedicaidState.Location = new System.Drawing.Point(257, 284);
			...
			this.butViewSSN.Location = new System.Drawing.Point(252, 6);
			...
			// butViewBirthdate
			// 
			this.butViewBirthdate.Enabled = false;
			this.butViewBirthdate.Location = new System.Drawing.Point(257, 263);
		...
		private UI.ComboBoxPlus comboZip;
		...
		private UI.ComboBoxPlus comboBillType;
		...
		private UI.ComboBoxPlus comboPriProv;
		private UI.ComboBoxPlus comboFeeSched;
		private UI.ComboBoxPlus comboSecProv;
		...
		private UI.ComboBoxPlus comboSpecialty;
