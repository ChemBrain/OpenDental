namespace OpenDental {
	partial class FormBugSubmissionHashVitals {
		...
		private void InitializeComponent() {
			...
			this.gridHashes = new OpenDental.UI.ODGrid();
			...
			this.gridHashData = new OpenDental.UI.ODGrid();
			...
			this.datePicker.DefaultDateTimeFrom = new System.DateTime(2019, 1, 1, 0, 0, 0, 0);
			this.datePicker.DefaultDateTimeTo = new System.DateTime(2019, 10, 11, 0, 0, 0, 0);
		...
		private UI.ODGrid gridHashData;
