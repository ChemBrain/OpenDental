namespace OpenDental{
	partial class FormOrthoCase {
		...
		private void InitializeComponent() {
			...
			this.TextVisitCountComplete = new OpenDental.ValidNumber();
			...
			this.textVisitCountPlanned = new OpenDental.ValidNumber();
			...
			this.textTreatmentLength = new OpenDental.ValidNumber();
			...
			this.gridOrthoSchedule = new OpenDental.UI.ODGrid();
			...
			// butDetachProcs
			// 
			this.butDetachProcs.Anchor = System.Windows.Forms.AnchorStyles.Bottom;
			...
			this.MaximumSize = new System.Drawing.Size(1246, 735);
			this.MinimumSize = new System.Drawing.Size(890, 457);
		...
		private ValidNumber textVisitCountPlanned;
		...
		private UI.ODGrid gridOrthoSchedule;
		...
		private ValidNumber TextVisitCountComplete;
		private System.Windows.Forms.Label labelTreatmentLength;
		private ValidNumber textTreatmentLength;
