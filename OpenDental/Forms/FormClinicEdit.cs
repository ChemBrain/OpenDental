...
namespace OpenDental {
	...
	public class FormClinicEdit : ODForm {
		...
		private UI.ComboBoxPlus comboInsBillingProv;
		...
		private UI.ComboBoxPlus comboDefaultProvider;
		...
		private void InitializeComponent()
		{
			...
			this.comboDefaultProvider = new OpenDental.UI.ComboBoxPlus();
    ...
    "ddress.";
		...
		private void butPickInsBillingProv_Click(object sender,EventArgs e) {
			FormProviderPick FormPP = new FormProviderPick(comboInsBillingProv.Items.GetAll<Provider>());
		...
		private void butPickDefaultProv_Click(object sender,EventArgs e) {
			FormProviderPick FormPP = new FormProviderPick(comboDefaultProvider.Items.GetAll<Provider>());
