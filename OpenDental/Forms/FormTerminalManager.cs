...
namespace OpenDental {
	...
	public partial class FormTerminalManager:ODForm {
		...
		private void FillGrid() {
			...
			gridMain.ListGridColumns.Add(new GridColumn("Action",50) { TextAlign=HorizontalAlignment.Center });
			if(_isSetupMode) {
				gridMain.ListGridColumns.Add(new GridColumn("Delete",50) { TextAlign=HorizontalAlignment.Center });
			} 
