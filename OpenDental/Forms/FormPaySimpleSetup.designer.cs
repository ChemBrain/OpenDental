namespace OpenDental{
	partial class FormPaySimpleSetup {
		...
		private void InitializeComponent() {
			...
			this.comboPaymentTypeCC = new UI.ComboBoxPlus();
			this.label1 = new System.Windows.Forms.Label();
			this.comboPaymentTypeACH = new UI.ComboBoxPlus();
		...
		private UI.ComboBoxPlus comboPaymentTypeCC;
		private System.Windows.Forms.Label label1;
		private System.Windows.Forms.CheckBox checkPreventSavingNewCC;
		private UI.ComboBoxPlus comboPaymentTypeACH;
