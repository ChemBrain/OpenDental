namespace OpenDental {
	partial class FormPaySplitEdit {
		...
		private void InitializeComponent(){
			...
			this.comboUnearnedTypes = new UI.ComboBoxPlus();
			this.comboProvider = new OpenDental.UI.ComboBoxPlus();
    ...
    ".";
		...
		private UI.ComboBoxPlus comboUnearnedTypes;
		private UI.ComboBoxPlus comboProvider;
