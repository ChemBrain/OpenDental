...
///<summary></summary>
	public class FormProcCodeEdit : ODForm {
		...
		private UI.ComboBoxPlus comboProvNumDefault;
		...
		private void InitializeComponent(){
			...
			this.comboProvNumDefault = new OpenDental.UI.ComboBoxPlus();
			...
			this.textBaseUnits.MaxVal = 255;
			this.textBaseUnits.MinVal = 0;
