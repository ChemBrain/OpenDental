...
///<summary></summary>
	public class FormMedical : ODForm {
		...
		private void FillMeds(bool isForPrinting = false) {
			...
			gridToFill.ListGridColumns.Add(col);
			col=new GridColumn(Lan.g("TableMedications","Notes"),-1);//-1 width forces ODGrid to dynamically size this column
			gridToFill.ListGridColumns.Add(col);
			col=new GridColumn(Lan.g("TableMedications","Notes for Patient"),-1);//-1 width forces ODGrid to dynamically size this column
			gridToFill.ListGridColumns.Add(col);
