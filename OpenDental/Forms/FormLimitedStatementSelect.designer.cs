namespace OpenDental{
	partial class FormLimitedStatementSelect {
		...
		private void InitializeComponent() {
			...
			this.listBoxTransTypes = new System.Windows.Forms.ListBox();
			...
			this.butNone.Location = new System.Drawing.Point(765, 372);
			...
			this.butAll.Location = new System.Drawing.Point(765, 312);
    ...
    "ited statement";
			...
			this.odDatePickerTo.DefaultDateTime = new System.DateTime(2020, 1, 1, 0, 0, 0, 0);
			...
			this.odDatePickerFrom.DefaultDateTime = new System.DateTime(2019, 1, 1, 0, 0, 0, 0);
			...
			// listBoxTransTypes
			// 
			this.listBoxTransTypes.Items.AddRange(new object[] {
            "Adjustment",
            "Procedure",
            "Payment",
            "Claim Payment"});
			...
			this.listBoxTransTypes.SelectionMode = System.Windows.Forms.SelectionMode.MultiSimple;
			...
			this.butToday.Location = new System.Drawing.Point(765, 342);
			...
			this.MinimumSize = new System.Drawing.Size(784, 446);
		...
		private System.Windows.Forms.ListBox listBoxTransTypes;
