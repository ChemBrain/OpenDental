...
///<summary></summary>
	public class FormRecallSetup : ODForm {
		...
		private UI.ComboBoxPlus comboStatusMailedRecall;
		private UI.ComboBoxPlus comboStatusEmailedRecall;
		...
		private UI.ComboBoxPlus comboStatusEmailTextRecall;
		private Label label5;
		private UI.ComboBoxPlus comboStatusTextedRecall;
		...
		private void InitializeComponent()
		{
			...
			this.comboStatusMailedRecall = new UI.ComboBoxPlus();
			...
			this.comboStatusEmailedRecall = new UI.ComboBoxPlus();
			...
			this.comboStatusEmailTextRecall = new UI.ComboBoxPlus();
			this.label5 = new System.Windows.Forms.Label();
			this.comboStatusTextedRecall = new UI.ComboBoxPlus();
