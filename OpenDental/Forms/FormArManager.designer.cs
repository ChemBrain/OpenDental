namespace OpenDental{
	partial class FormArManager {
		...
		private void InitializeComponent() {
			...
			this.comboDemandType = new UI.ComboBoxPlus();
			...
			this.comboClinicsUnsent = new OpenDental.UI.ComboBoxClinicPicker();
			...
			this.comboClinicsSent = new OpenDental.UI.ComboBoxClinicPicker();
			...
			this.comboExcludedDemandType = new UI.ComboBoxPlus();
			...
			this.comboClinicsExcluded = new OpenDental.UI.ComboBoxClinicPicker();
			...
			// groupUnsentFilters
			// 
			this.groupUnsentFilters.Controls.Add(this.comboClinicsUnsent);
			...
			// comboClinicsUnsent
			// 
			this.comboClinicsUnsent.IncludeAll = true;
			this.comboClinicsUnsent.IncludeUnassigned = true;
			this.comboClinicsUnsent.Location = new System.Drawing.Point(60, 16);
			this.comboClinicsUnsent.Name = "comboClinicsUnsent";
			this.comboClinicsUnsent.SelectionModeMulti = true;
			this.comboClinicsUnsent.Size = new System.Drawing.Size(197, 21);
			this.comboClinicsUnsent.TabIndex = 11;
			this.comboClinicsUnsent.SelectionChangeCommitted += new System.EventHandler(this.ComboClinicsUnset_SelectionChangeCommitted);
			this.comboClinicsUnsent.Leave += new System.EventHandler(this.ComboClinicsUnsent_Leave);
			// 
			...
			// groupSentFIlters
			// 
			this.groupSentFIlters.Controls.Add(this.comboClinicsSent);
			...
			// comboClinicsSent
			// 
			this.comboClinicsSent.IncludeAll = true;
			this.comboClinicsSent.IncludeUnassigned = true;
			this.comboClinicsSent.Location = new System.Drawing.Point(60, 16);
			this.comboClinicsSent.Name = "comboClinicsSent";
			this.comboClinicsSent.SelectionModeMulti = true;
			this.comboClinicsSent.Size = new System.Drawing.Size(197, 21);
			this.comboClinicsSent.TabIndex = 12;
			this.comboClinicsSent.SelectionChangeCommitted += new System.EventHandler(this.ComboClinicsSent_SelectionChangeCommitted);
			this.comboClinicsSent.Leave += new System.EventHandler(this.ComboClinicsSent_Leave);
			// 
			...
			// 
			this.groupExcludedFilters.Controls.Add(this.comboClinicsExcluded);
			...
			// 
			// comboClinicsExcluded
			// 
			this.comboClinicsExcluded.IncludeAll = true;
			this.comboClinicsExcluded.IncludeUnassigned = true;
			this.comboClinicsExcluded.Location = new System.Drawing.Point(60, 15);
			this.comboClinicsExcluded.Name = "comboClinicsExcluded";
			this.comboClinicsExcluded.SelectionModeMulti = true;
			this.comboClinicsExcluded.Size = new System.Drawing.Size(197, 21);
			this.comboClinicsExcluded.TabIndex = 13;
			this.comboClinicsExcluded.SelectionChangeCommitted += new System.EventHandler(this.ComboClinicsExcluded_SelectionChangeCommitted);
			// 
			// FormArManager
			// 
		...
		private UI.ComboBoxPlus comboDemandType;
		...
		private UI.ComboBoxPlus comboExcludedDemandType;
		...
		private UI.ComboBoxClinicPicker comboClinicsUnsent;
		private UI.ComboBoxClinicPicker comboClinicsSent;
		private UI.ComboBoxClinicPicker comboClinicsExcluded;
	}
}