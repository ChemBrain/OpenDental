...
///<summary></summary>
	public class FormEmployeeSelect : ODForm {
		...
		private void FillGrid(){
			...
			GridColumn col=new GridColumn(Lan.g("FormEmployeeSelect","FName"),75);
			gridMain.ListGridColumns.Add(col);
			col=new GridColumn(Lan.g("FormEmployeeSelect","LName"),75);
			gridMain.ListGridColumns.Add(col);
			col=new GridColumn(Lan.g("FormEmployeeSelect","MiddleI"),50);
			gridMain.ListGridColumns.Add(col);
			col=new GridColumn(Lan.g("FormEmployeeSelect","Hidden"),50,HorizontalAlignment.Center);
			gridMain.ListGridColumns.Add(col);
