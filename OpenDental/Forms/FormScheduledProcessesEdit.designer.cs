namespace OpenDental{
	partial class FormScheduledProcessesEdit {
		...
		private void InitializeComponent() {
			...
			this.comboFrequency = new OpenDental.UI.ComboBoxPlus();
			this.comboScheduledAction = new OpenDental.UI.ComboBoxPlus();
		...
		private UI.ComboBoxPlus comboScheduledAction;
		private UI.ComboBoxPlus comboFrequency;
