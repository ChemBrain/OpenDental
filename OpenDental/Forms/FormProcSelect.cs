    ...
    "e this income towards.";
      ...
      gridMain.ListGridRows.Clear();
		...
		private void gridMain_CellDoubleClick(object sender,ODGridClickEventArgs e) {
			_listSelectedProcs.Add(((ProcExtended)((AccountEntry)gridMain.ListGridRows[e.Row].Tag).Tag).Proc);
		...
		private void butOK_Click(object sender, System.EventArgs e) {
			...
			for(int i=0;i<gridMain.SelectedIndices.Length;i++) {
				_listSelectedProcs.Add(((ProcExtended)((AccountEntry)gridMain.ListGridRows[gridMain.SelectedIndices[i]].Tag).Tag).Proc);
			}
			DialogResult=DialogResult.OK;
		}
