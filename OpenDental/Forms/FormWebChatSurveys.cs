	...
	public partial class FormWebChatSurveys:ODForm {
		...
		private void FillGridWebChatSurveys() {
			...
			if(gridWebChatSurveys.ListGridColumns.Count==0) {
				...
				gridWebChatSurveys.ListGridColumns.Add(new GridColumn("Comment",0,HorizontalAlignment.Left));
				gridWebChatSurveys.ListGridColumns.Add(new GridColumn("Experience",0,HorizontalAlignment.Left));
			}
