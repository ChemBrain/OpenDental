namespace OpenDental {
	partial class FormRecallList {
		...
		private void InitializeComponent()
		{
			...
			this.comboSetStatusRecalls = new OpenDental.UI.ComboBoxPlus();
			...
			this.comboShowReminders = new OpenDental.UI.ComboBoxPlus();
			this.comboProviderRecalls = new OpenDental.UI.ComboBoxPlus();
			this.comboRecallTypes = new OpenDental.UI.ComboBoxPlus();
			...
			this.comboSiteRecalls = new OpenDental.UI.ComboBoxPlus();
			...
			this.comboSortRecalls = new OpenDental.UI.ComboBoxPlus();
			...
			this.comboSetStatusReact = new OpenDental.UI.ComboBoxPlus();
			this.butSetStatusReact = new OpenDental.UI.Button();
			this.groupViewReact = new System.Windows.Forms.GroupBox();
			this.comboProviderReact = new OpenDental.UI.ComboBoxPlus();
			...
			this.comboBillingTypes = new OpenDental.UI.ComboBoxPlus();
			this.labelBillingTypes = new System.Windows.Forms.Label();
			this.comboShowReactivate = new OpenDental.UI.ComboBoxPlus();
			this.labelShowReactivate = new System.Windows.Forms.Label();
			this.comboSortReact = new OpenDental.UI.ComboBoxPlus();
			this.labelSortByReact = new System.Windows.Forms.Label();
			this.comboSiteReact = new OpenDental.UI.ComboBoxPlus();
			...
			this.datePickerRecalls.DefaultDateTimeFrom = new System.DateTime(((long)(0)));
			this.datePickerRecalls.DefaultDateTimeTo = new System.DateTime(((long)(0)));
			...
			this.datePickerRemind.DefaultDateTimeFrom = new System.DateTime(((long)(0)));
			this.datePickerRemind.DefaultDateTimeTo = new System.DateTime(((long)(0)));
			...
			this.datePickerReact.DefaultDateTimeFrom = new System.DateTime(((long)(0)));
			this.datePickerReact.DefaultDateTimeTo = new System.DateTime(((long)(0)));
		...
		private OpenDental.UI.ODGrid gridRecalls;
		private System.Windows.Forms.GroupBox groupSetStatusRecalls;
		private UI.ComboBoxPlus comboSetStatusRecalls;
		...
		private UI.ComboBoxPlus comboSiteRecalls;
		...
		private UI.ComboBoxPlus comboShowReactivate;
		private System.Windows.Forms.Label labelShowReactivate;
		private UI.ComboBoxPlus comboSortReact;
		private System.Windows.Forms.Label labelSortByReact;
		private UI.ComboBoxPlus comboSiteReact;
		...
		private UI.ComboBoxPlus comboSortRecalls;
		private UI.ComboBoxPlus comboRecallTypes;
		private UI.ComboBoxPlus comboProviderRecalls;
		private UI.ComboBoxPlus comboProviderReact;
		private UI.ComboBoxPlus comboShowReminders;
	}
}
