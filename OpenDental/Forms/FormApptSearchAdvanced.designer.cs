namespace OpenDental{
	partial class FormApptSearchAdvanced {
		...
		private void InitializeComponent() {
			...
			this.comboBlockout = new UI.ComboBoxPlus();
			...
			this.comboApptView = new UI.ComboBoxPlus();
		...
		private UI.ComboBoxPlus comboBlockout;
		...
		private UI.ComboBoxPlus comboApptView;
