...
namespace OpenDental{
	...
	public class FormClearinghouseEdit : ODForm {
		...
		private UI.ComboBoxPlus comboFormat;
		...
		private UI.ComboBoxPlus comboCommBridge;
