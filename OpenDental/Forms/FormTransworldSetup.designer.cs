namespace OpenDental{
	partial class FormTransworldSetup {
		...
		private void InitializeComponent() {
			...
			this.comboNegAdjType = new UI.ComboBoxPlus();
			this.comboPosAdjType = new UI.ComboBoxPlus();
			...
			this.comboPaidInFullBillType = new UI.ComboBoxPlus();
    ...
    " and login credentials for that clinic.";
		...
		private UI.ComboBoxPlus comboPaidInFullBillType;
		private UI.ComboBoxPlus comboNegAdjType;
		private UI.ComboBoxPlus comboPosAdjType;
