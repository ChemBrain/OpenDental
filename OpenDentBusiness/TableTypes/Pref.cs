...
namespace OpenDentBusiness {
	...
	public enum PrefName {
		...
		///<summary>For enterprise users. With this enabled, the All option will not show in the clinic comboboxes for the following Appt 6 Lists: Recall, Confirmation, Planned Appt Tracker, Unsched, ASAP, Ins Verification.</summary>
		EnterpriseApptList,
