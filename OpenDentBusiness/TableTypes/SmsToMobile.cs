...
namespace OpenDentBusiness {
	...
	public enum SmsMessageSource{
		...
		Headmaster,
		///<summary>14. Used with Short Codes to send an AutoReply message.</summary>
		AutoReply,
		///<summary>15. Send from OD Mobile app.</summary>
		[Description("OD Mobile")]
		ODMobile,
		///<summary>16. Used when sending appointment/schedule Thank You's.</summary>
		[Description("Schedule Thank You")]
		ScheduleThankYou,
		///<summary>17. Used when the patient responds positively to an eConfirmation.</summary>
		[Description("Confirmation Auto Reply")]
		ConfirmationAutoReply,
		///<summary>18. Used with Short Codes to send a message prompting the patient to opt in to receiving Short Code sms.</summary>
		OptInPrompt,
		///<summary>19. Used with Short Codes to send a message confirming the patient has opted out of receiving Short Code sms.</summary>
		StopReply,
		///<summary>20. Used with Short Codes to send a message detailing help options for the patient.</summary>
		HelpReply,
		///<summary>21. Used with Short Codes to send a message confirming the patient has opted in to receiving Short Code sms.</summary>
		OptInReply,
	}
