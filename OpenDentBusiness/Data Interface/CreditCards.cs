...
namespace OpenDentBusiness{
	...
	public class CreditCards{
		...
		public static List<CreditCard> Refresh(long patNum){
			...
			return RefreshBySource(patNum,new List<CreditCardSource>() { CreditCardSource.None,CreditCardSource.PayConnect,CreditCardSource.PayConnectPortal,CreditCardSource.XServer,
