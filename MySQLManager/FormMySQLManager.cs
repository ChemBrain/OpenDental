...
namespace MySQLManager {
	public partial class FormMySQLUserManager:Form {
		...
		private void EditUser() {
			...
			FormMySQLUserEdit formMySQLUserEdit=new FormMySQLUserEdit(user,false,_dataConnection);
		...
		private void butAdd_Click(object sender,EventArgs e) {
			FormMySQLUserEdit formMySQLUserEdit=new FormMySQLUserEdit("",true,_dataConnection);
			formMySQLUserEdit.ShowDialog();
			if(formMySQLUserEdit.DialogResult!=DialogResult.OK) {
				return;
			}
